...
`);
    ...
    if (sideSelect === "right") {
        ...
        addNoteRotated(svg, xLeftDim - 90, padY + 170, settings.LeftNotes, -90);
    }
    else {
        addNoteRotated(svg, xLeftDim - 350, padY + 170, settings.rightNotes, -90);
        addNoteRotated(svg, xRightDim + 300, padY + 180, settings.LeftNotes, 90);
    }
